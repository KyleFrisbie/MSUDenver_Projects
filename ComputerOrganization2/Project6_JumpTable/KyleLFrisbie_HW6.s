...
SWI_EXIT	EQU	&11			; finish program
		...
		MOV	r0, #2			; set r0 to 3, to call PRINT subroutine
		ADR	r4, MESSAGE		; store address of ESTRING to r4
		BL	JUMPTABLE		; branch and link to jumpTABLE, run PRINT
		MOV	r0, #3			; set r0 to 4, to call PERMU subroutine
		...
		BL	JUMPTABLE		; branch and link to jumpTABLE, run PRINT 
		MOV	r0, #1			; set r0 to 0, to call DECRYPT subroutine
		BL	JUMPTABLE		; branch and link to jumpTABLE, run DECRYPT
		MOV	r0, #3			; set r0 to 4, to call PERMU subroutine
		ADR	r2, DSTRING		; store the address of the message in r2
		BL	JUMPTABLE		; branch and link to jumpTABLE, run PERMU
		MOV	r0, #2
...
MASK		DCD	&000000FF
KEY		DCD	&CCCCCCCC
MESSAGE		DCB	"I love computers!",&00000000
DSTRING		% 50
PSTRING		% 50
ESTRING		% 50
		ALIGN
