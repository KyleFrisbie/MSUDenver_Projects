	...
	; 
	; Project: Homework6_KyleLFrisbie
...
MASK		DCD	&000000FF
KEY		DCD	&FFFFFFFF
MESSAGE		DCB	"I love writing software!",&00,&00,&00,&00
PSTRING		% 40
Blank1		DCD	&00000000
ESTRING		% 40
Blank2		DCD	&00000000
...
ENCRYPT		; store registers in stack
		...
		; XOR the message
		ADR	r3, ESTRING		; load r2 with address of ESTRING, for XOR subroutine
...
DECRYPT		; store registers in stack
		...
		ADR	r2, ESTRING		; load r2 with address of PSTRING, for XOR subroutine
		MOV	r0, #5			; load r0 with 5, points to XOR subroutine
		BL	JUMPTABLE		; go to XOR via JUMPTABLE
